...
Project.create(name: "Travel App", image:"tour-guide.jpg", description:"It is a tour guide built using ruby on rails framework.It has different categories of destinations and the user can view description of a particular destination. The user can edit the title and description of the destination.",  tag_id: t1.id)
Project.create(name: "Threadly", image:"threadly.jpg", description: "Web-app built using Ruby on Rails that demonstrates database connectivity.The user can enter their thaughts and then view them later anytime.", tag_id: t1.id)
Project.create(name: "Innovation Cloud", image:"innovation-cloud.jpg" , description: "Web-app built using Ruby on Rails that demonstrates database connectivity.", tag_id: t1.id)
