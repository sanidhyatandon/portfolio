...
Project.create(project_link: "http://travel-escort.herokuapp.com/", name: "Travel App", image:"tour-guide.jpg", description:"It is a tour guide built using ruby on rails framework.It has different categories of destinations and the user can view description of a particular destination. The user can edit the title and description of the destination.",  tag_id: t1.id)
Project.create(project_link: "http://threadly-thaughts.herokuapp.com/", name: "Threadly", image:"threadly.jpg", description: "Web-app built using Ruby on Rails that demonstrates database connectivity.The user can enter their thaughts and then view them later anytime.", tag_id: t1.id)
Project.create(project_link: "http://innovation-clouds.herokuapp.com/", name: "Innovation Cloud", image:"innovation-cloud.jpg" , description: "Web-app built using Ruby on Rails that demonstrates database connectivity.", tag_id: t1.id)
